...
export default function FeatureSec({featureData,...props}:featureProps) {
          ...
          <Grid item xs={12} md={6}>
            <Box className="fea_lft">
              <Typography variant="h2">
                <span>{featureData?.features_hdr} </span> 
              </Typography>
              <Typography variant="body1">
              {featureData?.features_sub_hdr}
              </Typography>
              <List disablePadding>
                <ListItem disablePadding>
                  ...
                  <Box className="fea_txt">
                    <Typography variant="h3">{featureData?.features_content_hdr_1}</Typography>
                    <Typography variant="body1">
                ...
                <ListItem disablePadding>
                  ...
                  <Box className="fea_txt">
                    <Typography variant="h3">{featureData?.features_content_hdr_2} </Typography>
                    <Typography variant="body1">
                ...
                <ListItem disablePadding>
                  ...
                  <Box className="fea_txt">
                    <Typography variant="h3">{featureData?.features_content_hdr_3}</Typography>
                    <Typography variant="body1">
