import { Data, LandingPageInterFace } from "@/interface/landingPageInterFace";
        ...
        <Box className="app_title">
          <Typography variant="h2">
            <Typography variant="caption" className="red_span">
             {useData?.how_to_use_hdr}
            </Typography>
            <Typography>
              {useData?.how_to_use_sub_hdr}
            </Typography>            
          </Typography>
          <Typography>
        ...
        <Stack direction="row" flexWrap="wrap" className="app_content">
          <List disablePadding className="small_block">
            <ListItem disablePadding>
              ...
              <Typography variant="h4">{useData?.how_to_use_content_hdr_1}</Typography>
              <Typography>
              {useData?.how_to_use_content_text_1}
              </Typography>
            </ListItem>
            <ListItem disablePadding>
              <Typography variant="caption" className="poly_gon">
              ...
              <Typography variant="h4">{useData?.how_to_use_content_hdr_2}</Typography>
              <Typography>
               {useData?.how_to_use_content_text_2}
              </Typography>
            </ListItem>
          </List>
          ...
          <List disablePadding className="small_block">
            <ListItem disablePadding>
              ...
              <Typography variant="h4">{useData?.how_to_use_content_hdr_3}</Typography>
              <Typography>
              {useData?.how_to_use_content_text_3}
              </Typography>
            </ListItem>
            <ListItem disablePadding>
              <Typography variant="caption" className="poly_gon">
              ...
              <Typography variant="h4">{useData?.how_to_use_content_hdr_4}</Typography>
              <Typography>
               {useData?.how_to_use_content_text_4}
              </Typography>
            </ListItem>
          </List>
        </Stack>
